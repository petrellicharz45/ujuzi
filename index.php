...
<html lang="en">
    ...
    <body>
        ...
        <div class="mn-content fixed-sidebar">
                ...
                <nav class="cyan darken-1">
                    <div class="nav-wrapper row">
                        ...
                        <div class="header-title col s5">
                            <span class="chapter-title"> Nakasero Hospital Employee Leave Management System</span>
                        </div>
            ...
            <aside id="slide-out" class="side-nav green fixed">
          ...
          <div class="footer">
            ...
            <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title"><h4>Welcome to Nakasero Hospital Employee Leave Management System</h4></div>
